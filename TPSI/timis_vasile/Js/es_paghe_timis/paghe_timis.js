function add(){
    const input = [document.getElementById('dipartimento').value,
    ...
    document.getElementById('tabella').children[0].appendChild(tr)
}


function media(){
    const table = document.getElementById('tabella').children[0]
